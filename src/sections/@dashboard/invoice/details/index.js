      ...
      <Card sx={{ pt: 5, px: 5 }}>
        <Grid container>
          <Grid item xs={12} sm={6} sx={{ mb: 5 }}>
            <Image disabledEffect visibleByDefault alt="logo" src="https://images.durrbar.com/logo/durrbar-full-logo.svg" sx={{ maxWidth: 120 }} />
          </Grid>
        ...
        <Grid container>
          ...
          <Grid item xs={12} md={3} sx={{ py: 3, textAlign: 'right' }}>
            ...
            <Typography variant="body2">support@durrbar.com</Typography>
          </Grid>
        </Grid>
      </Card>
    </>
