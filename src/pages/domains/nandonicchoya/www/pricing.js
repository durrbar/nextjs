...
// sections
import { PricingPlanCard } from '../../../../sections/commons';
...
Pricing.getLayout = function getLayout(page) {
  return <Layout variant="logoOnly" navVariant="wwwNC" siteName='nandonicchoya'>{page}</Layout>;
};
...
export default function Pricing() {
  return (
    <Page title="Pricing" siteName="Nandonic Choya">
      <RootStyle>
        <Container>
