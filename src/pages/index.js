...
export default function HomePage() {
  return (
    <Page title="Durrbar" noSiteName meta={meta}>
      <RootStyle1>
      <MotionContainer>
      <RootStyle2>
        <HeroOverlayStyle
        ...
        <HeroImgStyle
          alt="hero"
          src={`${assetsUrl}/logo/durrbar-icon.svg`}
          ...
          <ContentStyle>
            ...
            <m.div variants={varFade().inRight}>
              <Typography sx={{ color: 'common.white' }}>
                The Company of Solution. To provide you the best experiance in life.
              </Typography>
            </m.div>
            ...
            <m.div variants={varFade().inRight}>
              <NextLink href="https://www.durrbar.com/" passHref legacyBehavior>
                <Button
                  size="large"
                  variant="contained"
            ...
            <Stack spacing={2.5}>
              ...
              <Stack direction="row" spacing={1.5} justifyContent={{ xs: 'center', md: 'flex-start' }}>
                {['durrbar-icon', 'tasfiashopping-full'].map((resource) => (
                  <LogoImgStyle
                    key={resource}
                    variants={varFade().inRight}
                    sx={{ height: '50px', width: '50px' }}
                    src={`${assetsUrl}/logo/${resource}.svg`}
                  />
                ))}
                <LogoImgStyle variants={varFade().inRight} sx={{ height: '50px', width: '50px' }} src={`${assetsUrl}/logo/nandonic.png`}
                  />
              </Stack>
            </Stack>
          </ContentStyle>
